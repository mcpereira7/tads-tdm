...
public class BimestreCFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(tads.tdm.mediaescolar.R.layout.fragment_bimestre_c, container, false);

        editMateria = view.findViewById(tads.tdm.mediaescolar.R.id.editMateria);
        editNotaProva = view.findViewById(tads.tdm.mediaescolar.R.id.editNotaProva);
        editNotaTrabalho = view.findViewById(tads.tdm.mediaescolar.R.id.editNotaTrabalho);
        txtResultado = view.findViewById(tads.tdm.mediaescolar.R.id.txtResultado);
        txtSituacaoFinal = view.findViewById(tads.tdm.mediaescolar.R.id.txtSituacaoFinal);
        btnCalcular = view.findViewById(tads.tdm.mediaescolar.R.id.btnCalcular);
